...
func customOperator(left float64, right float64, operator string) (interface{}, error) {
	switch operator {
	case "gte":
	...
	case "notEqual":
		return boolIface(left != right), nil
	default:
		return nil, errors.New("unsupported operator in evaluationState#customOperator")
	}
}

func customStateFloatAndString(left interface{}, right interface{}, operator string) (interface{}, error) {
	...
	if leftValue, ok1 := left.(float64); ok1 {
		if rightValue, ok2 := right.(string); ok2 {
			...
			if err == nil {
				return customOperator(leftValue, rightNum, operator)
			}
		}
	}
	...
	if leftValue, ok1 := left.(string); ok1 {
		if rightValue, ok2 := right.(float64); ok2 {
			...
			if err == nil {
				return customOperator(leftNum, rightValue, operator)
			}
		}
	}
	return nil, nil
...
func gteStage(left interface{}, right interface{}, parameters Parameters) (interface{}, error) {
	customOpResult, err := customStateFloatAndString(left, right, "gte")
	if customOpResult != nil && err == nil {
		return customOpResult, nil
	}
	if isString(left) && isString(right) {
...
func gtStage(left interface{}, right interface{}, parameters Parameters) (interface{}, error) {
	customOpResult, err := customStateFloatAndString(left, right, "gt")
	if customOpResult != nil && err == nil {
		return customOpResult, nil
	}
	if isString(left) && isString(right) {
...
func lteStage(left interface{}, right interface{}, parameters Parameters) (interface{}, error) {
	customOpResult, err := customStateFloatAndString(left, right, "lte")
	if customOpResult != nil && err == nil {
		return customOpResult, nil
	}
	if isString(left) && isString(right) {
...
func ltStage(left interface{}, right interface{}, parameters Parameters) (interface{}, error) {
	customOpResult, err := customStateFloatAndString(left, right, "lt")
	if customOpResult != nil && err == nil {
		return customOpResult, nil
	}
	if isString(left) && isString(right) {
...
func equalStage(left interface{}, right interface{}, parameters Parameters) (interface{}, error) {
	customOpResult, err := customStateFloatAndString(left, right, "equal")
	if customOpResult != nil && err == nil {
		return customOpResult, nil
	}
...
func notEqualStage(left interface{}, right interface{}, parameters Parameters) (interface{}, error) {
	customOpResult, err := customStateFloatAndString(left, right, "notEqual")
	if customOpResult != nil && err == nil {
		return customOpResult, nil
	}
	return boolIface(!reflect.DeepEqual(left, right)), nil
...
func comparatorTypeCheck(left interface{}, right interface{}) bool {
	...
	if (isFloat64(left) && isString(right)) || (isString(left) && isFloat64(right)) {
		return true
	}
